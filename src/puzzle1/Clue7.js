  ...
  return (
    ...
    <div className='b7'>
      <div className='container7'>
        ...
        <h2 style={{color:"darkgreen", paddingTop:"15px",fontFamily: "Georgia, serif",paddingLeft:"35px"}}>The boy after cruzing through the forest he can't find the correct way back help him by solving the below question:</h2>
        <h2 style={{color:"#4B0082", paddingTop:"5px",fontFamily: "Georgia, serif" ,paddingLeft:"35px"}}>If South-West becomes East, South-East becomes North and so on. What will North become?</h2>
