  ...
  return (
    ...
    <div className='b2'>
      ...
      <div className='container'>
        ...
        <h2 style={{ color: 'black', paddingTop: '15px', fontFamily: 'Georgia, serif',paddingLeft: '35px' }}>
        ...
        <h2 style={{ color: '#4B0082', paddingTop: '5px', fontFamily: 'Georgia, serif', paddingLeft: '35px' }}>
